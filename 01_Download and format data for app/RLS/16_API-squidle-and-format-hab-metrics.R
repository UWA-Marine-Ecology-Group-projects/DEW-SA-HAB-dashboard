...
unique(benthos$label_lineage_names)

test <- benthos %>% dplyr::filter(is.na(label_lineage_names)) # 15,820 points not labelled
...
write_rds(benthos_final, "data/raw/rls_benthos_summarised.rds")
